...
if __name__ == '__main__':
    ...
    adjective = simpledialog.askstring(title= 'Mad Libs', prompt= 'Please enter an adjective')
    # Get the player to enter a type of liquid
    liquid = simpledialog.askstring(title= 'Mad Libs part 2', prompt= 'Please enter a liquid')
    # Get the player to enter a body part
    body_part = simpledialog.askstring(title= 'Mad Libs part 3', prompt= 'Please enter a body_part')
    # Get the player to enter a verb
    verb = simpledialog.askstring(title= 'Mad Libs part 4', prompt= 'Please enter a verb')
    # Get the player to enter a place
    place = simpledialog.askstring(title= 'Mad Libs final part: part 5', prompt= 'Please enter a place')
    ...
    messagebox.showinfo(title= 'Mad Libs Story', message= story)
